...
import type { WorldNewsItem } from "@/app/api/world-news/route";

const SOURCE_STYLES: Record<string, { bg: string; text: string }> = {
  "BBC":        { bg: "bg-indigo-100", text: "text-indigo-700" },
  "Al Jazeera": { bg: "bg-amber-100",  text: "text-amber-700"  },
  "Dawn":       { bg: "bg-emerald-100",text: "text-emerald-700"},
  "NY Times":   { bg: "bg-rose-100",   text: "text-rose-700"   },
};
  ...
  return (
    <div className="card flex flex-col" style={{ height: "300px" }}>
      ...
      <div className="flex items-center justify-between mb-3 flex-shrink-0">
        <p className="widget-label mb-0">World News</p>
          ...
          <div className="space-y-3">
            {[...Array(5)].map((_, i) => (
              <div key={i} className="animate-pulse flex gap-2">
                <div className="h-3 w-12 bg-gray-100 rounded-full mt-0.5 flex-shrink-0" />
